...
## Dataset: Attached with this email
...
- Input Features:
  ...
  - Gender: Gender of the insured person (male, female).
  ...
  - region: Region where the insured resides (northeast, northwest, southeast, southwest).

- Target Variable:
  - charges: The medical insurance costs billed to the insured.
